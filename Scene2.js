class Scene2 extends Phaser.Scene {
  ...
  hurtPlayer(player, enemy) {
    ...
    // don't hurt the player if they're invincible
    ...
    // disables the player and hides them
  ...
  resetPlayer(){
    ...
    //
    // player is transparent to show invincible
    this.player.alpha = 0.5;
    //
    //
    // move the ship from outside the screen to original position
